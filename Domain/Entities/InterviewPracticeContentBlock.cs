...
public sealed class InterviewPracticeContentBlock
{
    [Key]
    [Column("id")]
    public Guid Id { get; set; } = Guid.NewGuid();

    [Column("interview_practice_id")]
    public Guid InterviewPracticeId { get; set; }
    ...
    [ForeignKey(nameof(InterviewPracticeId))]
    public InterviewPractice InterviewPractice { get; set; } = null!;
}
